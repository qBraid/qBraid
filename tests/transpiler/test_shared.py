"""
Unit tests for transpiling circuits composed of gate types that share explicit support across
multiple qbraid tranpsiler supported packages.
"""
import pytest
import qiskit
import cirq
...
def test_qiskit_to_cirq_shared_gates(qiskit_circuit, cirq_unitary):
...
def test_cirq_to_qiskit_shared_gates(cirq_circuit, qiskit_unitary):
...
def test_qiskit_to_braket_shared_gates(qiskit_circuit, braket_unitary):
...
def test_braket_to_qiskit_shared_gates(braket_circuit, qiskit_unitary):
...
def test_cirq_to_braket_shared_gates(cirq_circuit, braket_unitary):
...
def test_braket_to_cirq_shared_gates(braket_circuit, cirq_unitary):
