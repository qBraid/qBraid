...
abstract parameters are stored locally as attributes of gates. Circuit objects have methods that
can generate of a comprehensive list of qubits or parameters, but these are inefficient.
...
the transpiler has a decicated wrapper object for moments, though this object is not used for 
any other package.
