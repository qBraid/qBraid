...
def qasm2_to_qasm3(program: "qbraid.QPROGRAM") -> str:
    ...
    try:
        if "qiskit" in package:
            from qbraid.transpiler.qasm3_qiskit.conversions import qiskit_to_qasm3
        ...
        if package == "qasm2":
            from qbraid.transpiler.qasm_node.convert_qasm import qasm2_to_qasm3 as qasm2_to_qasm3
...
def convert_from_qasm3(program: str, frontend: str) -> "qbraid.QPROGRAM":
    ...
    try:
        if frontend == "qiskit":
            from qbraid.transpiler.qasm3_qiskit.conversions import qiskit_from_qasm3
