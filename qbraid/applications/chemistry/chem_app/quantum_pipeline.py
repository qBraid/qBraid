...
def qiskit_quantum_code_run(
    ...
    output = quantum_calc_output(
        classical_output.molecule_name,
        classical_output.geometry,
        classical_output.basis,
        library="qiskit",
    )
    output.fermionic_operator = fer_op
    output.qubit_operator = qubit_op
    code_str = qiskit_quantum_code_print(classical_output, mapping, qubit_tapering)
    if algo == "exact_diag":
...
def openfermion_quantum_code_run(
    ...
    int_op = InteractionOperator(
        0,
        one_body_tensor=classical_output.one_body_integrals,
    ...
    code_str = openfermion_quantum_code_print(classical_output, mapping, qubit_tapering)
    return code_str, output
