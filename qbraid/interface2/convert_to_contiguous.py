...
def convert_to_contiguous(circuit: QPROGRAM, **kwargs) -> QPROGRAM:
    ...
    if "cirq" in package:
        from qbraid.interface2.qbraid_cirq.contiguous import _convert_to_contiguous_cirq

        conversion_function = _convert_to_contiguous_cirq
    elif "braket" in package:
        from qbraid.interface2.qbraid_braket.contiguous import _convert_to_contiguous_braket
