...
import qbraid.transpiler2.cirq_utils.custom_gates as cirq_qasm_gates
from qbraid.transpiler2.cirq_utils.qasm_parser import QasmParser
from qbraid.transpiler2.cirq_utils.qasm_conversions import _remove_qasm_barriers
...
"""
    ...
    with pytest.raises(
        QasmException,
        match=r".*{}.* takes 0 parameter\(s\).*got.*1.*line 5".format(qasm_gate),
    ):
        parser.parse(qasm)
