    ...
    def __init__(
        ...
        Args:
            executor: A function which inputs a program and outputs a
                ``qbraid.transpiler2.QuantumResult``, or inputs a sequence of programs
                and outputs a sequence of ``qbraid.transpiler2.QuantumResult`` s.
    ...
    def _run(
        ...
        **kwargs: Any,
        ...
        if force_run_all:
            ...
            # TODO: Bug! These conversions to/from Cirq are not safe in that,
