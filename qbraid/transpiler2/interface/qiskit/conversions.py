...
from qbraid.transpiler2.utils import _convert_to_line_qubits
...
def to_qiskit(circuit: cirq.Circuit) -> qiskit.QuantumCircuit:
    ...
    """
    compat_circuit = _convert_to_line_qubits(
        circuit, rev_qubits=True, qasm_zpow=True
    )
...
def from_qiskit(circuit: qiskit.QuantumCircuit) -> cirq.Circuit:
    ...
    """
    cirq_circuit = from_qasm(circuit.qasm())
