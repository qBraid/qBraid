...
### Fixed
- Fixed `cached_method` raising `TypeError` before entering decorated methods when an argument was not JSON serializable; cache keys now fall back to the argument representation ([#1284](https://github.com/qBraid/qBraid/pull/1284))
