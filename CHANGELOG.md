...
### Fixed
- Connectivity graphs now show missing or out-of-range calibration errors as unavailable instead of letting them appear perfect or distort the color scale ([#1430](https://github.com/qBraid/qBraid/issues/1430)).
