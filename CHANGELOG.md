...
### Fixed
- Fixed QASM 3 to QASM 2 conversion splitting complete multi-bit measurement registers into separate single-bit registers. Backends that report counts per register, including OQC, can now return joint counts for these circuits ([#1443](https://github.com/qBraid/qBraid/pull/1443)).
