...
### Improved / Modified
- An OQC task that has been accepted and is waiting to run, for example for the device's next access window, now reports `JobStatus.QUEUED` instead of `INITIALIZING` ([#PR](https://github.com/qBraid/qBraid/pull/PR))
