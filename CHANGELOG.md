...
### Fixed
- `OQCDevice.get_next_window()` now raises `ResourceNotFoundError` for a device with no upcoming access window, such as an always-on simulator, instead of an `AttributeError` ([#1438](https://github.com/qBraid/qBraid/pull/1438))
