...
- Cirq and PyTKET circuits with unresolved parameters now raise `ProgramConversionError` naming those parameters when converting to Braket or OpenQASM 2, instead of leaking NumPy or SymPy `TypeError`s ([#1363](https://github.com/qBraid/qBraid/issues/1363))
