...
### Improved / Modified
- README header and runtime diagram now follow the reader's GitHub theme. The header uses the official brand SVG lockup, and the diagram is redrawn as generated SVG naming the actual pipeline stages (`transpile`, `transform`, `validate`, `submit`) — the previous one omitted `validate` ([#1338](https://github.com/qBraid/qBraid/pull/1338))
