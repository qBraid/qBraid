...
### Fixed
- Connectivity graphs now show missing or out-of-range calibration errors as unavailable instead of letting them appear perfect or distort the color scale ([#1435](https://github.com/qBraid/qBraid/pull/1435)).
