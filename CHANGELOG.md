...
### Added
- Added integration with IQM Resonance for running quantum programs on IQM devices. The `iqm` extra supports Python 3.11–3.12, matching IQM's transitive requirements. ([#1149](https://github.com/qBraid/qBraid/pull/1149))
