...
### Dependencies
- Bumped the `amazon-braket-sdk` upper bound from `<1.127.0` to `<1.128.0`, so Python 3.11+ environments resolve `1.127.1`. Python 3.10 is unaffected: `amazon-braket-sdk` requires 3.11+ from `1.111.0` on, so 3.10 stays on `1.110.1` and `amazon-braket-schemas` `1.28.0` no matter where the cap sits
