...
### Fixed
- OQC jobs now reject `shots` or `repeats` below 1 before submission, instead of silently using the default repeat count when `shots=0` ([#1441](https://github.com/qBraid/qBraid/issues/1441)).
