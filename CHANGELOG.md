...
### Added
- Added support for Python 3.14: added the `Programming Language :: Python :: 3.14` classifier and 3.14 to the CI test matrices ([#1085](https://github.com/qBraid/qBraid/issues/1085), [#1242](https://github.com/qBraid/qBraid/pull/1242))
...
- Added support for batch jobs for devices from Azure provider. The `AzureQuantumDevice.submit` method now accepts single and batched `qbraid.programs.QPROGRAM` inputs. ([#953](https://github.com/qBraid/qBraid/issues/953), [#985](https://github.com/qBraid/qBraid/pull/985))
...
- Added a `measurement_probabilties` argument to the `GateModelResultData` class. ([#785](https://github.com/qBraid/qBraid/issues/785), [#988](https://github.com/qBraid/qBraid/pull/988))
