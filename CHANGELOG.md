...
- Pin `pyqasm` version to 0.3.0 mitigate bug CI failure due to program validation bug: https://github.com/qBraid/pyqasm/issues/175 ([#957](https://github.com/qBraid/qBraid/pull/957))
